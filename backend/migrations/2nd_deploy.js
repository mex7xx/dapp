...
module.exports = async function(deployer) {
  ...
  aT = await assetToken.deployed();

  await aT.initialize(initialSupply, childName, childSymbol, childNumberOfSupervisors, childElectionFactoryAddress, ratioFollower, ratioInitiator ,zeroAddress, zeroAddress);
